...
import { ItemDescrModal } from '../../ItemDescrModal/ItemDecrModal'


export const MenuItem = observer(({ id, imgPath, productName, sellPrice, currency, volume, measure, descr }) => {
    ...
    <>
      ...
      <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12  mb-3">
        <div className={`card h-100 ${quantity !== 0 ? 'card-picked' : ''}`} >
          ...
          />
          <button class="btn info-card-btn" type="button" onClick={infoBtnHandler}>
            <img src={require(`../../../../src/img/info-icon.png`)} alt="картинка с info" />
          </button>
